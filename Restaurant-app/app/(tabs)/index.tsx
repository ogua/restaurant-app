...
import { Image, StyleSheet, Platform, ScrollView, SafeAreaView, FlatList, View, TouchableOpacity, RefreshControl } from "react-native";
import {
  Card,
  Dialog,
  List,
              ...
              {loading ? (
                ...
                <>
                  ...
                  >
                    ...
                    <Button onPress={() => router.push("/view-all")}>
                      View All
                    </Button>
                  </View>
                  ...
                  {visibiliy && (
                    <>
                      ...
                      <FlatList
                        data={availablecusine}
                        renderItem={({ item }) => (
                          <AvailablecuisineList item={item} />
                        )}
                        ItemSeparatorComponent={() => (
                          <View style={styles.separator} />
                        )}
